...
```
В кабинете разработчика Яндекс по [ссылке](https://developer.tech.yandex.ru/services) получите ключ API для Яндкс.Карт,
в файл `.env` добавьте такой код:
```sh
...
- `ROLLBAR_ENVIRONMENT` - окружение Rollbar
